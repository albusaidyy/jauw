...
class FormartUtils {
   String formatDateTimeWithTimeZone(
      {required int dt, required int timeZone}) {
    String formattedDateTime = formatDateTime(dt,timeZone);
    String formattedTimeZone = formatTimeZone(timeZone);

    return '$formattedDateTime $formattedTimeZone';
  }

String formatDateTime(int dt, int timeZoneOffsetSeconds) {
    // Convert Unix timestamp to DateTime
  DateTime utcDateTime = DateTime.fromMillisecondsSinceEpoch(dt * 1000, isUtc: true);
